...
const DesktopView: FC<IPageProps> = ({ setPage, currentPage, category }) => {
  ...
  return (
    <>
      ...
      <div className="flex justify-center p-4 mt-50">
        ...
        <div id="content-container" className="w-full max-w-5xl  sm:w-sm px-5">
          ...
          <div className="flex flex-col md:flex-row  gap-5  ">
            ...
            >
              <h1 className="font-semibold text-2xl uppercase">{currentPage && currentPage.replaceAll('-', ' ')}</h1>
